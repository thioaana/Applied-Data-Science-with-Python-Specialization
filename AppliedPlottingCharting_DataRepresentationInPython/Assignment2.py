...
# This is the dataset to use for this assignment. Note: The data for this assignment comes from a subset
# of The National Centers for Environmental Information (NCEI) [Daily Global Historical Climatology Network]
# (https://www1.ncdc.noaa.gov/pub/data/ghcn/daily/readme.txt) (GHCN-Daily).
...
# 
# 1. Read the documentation and familiarize yourself with the dataset, then write some python code which returns
...
# 3. Watch out for leap days (i.e. February 29th), it is reasonable to remove these points from the dataset
...
def leaflet_plot_stations(binsize, hashid):
    ...
    # df = pd.read_csv('data/C2A2_data/BinSize_d{}.csv'.format(binsize)) # For Jupyter
    df = pd.read_csv("data/fb441e62df2d58994928907a91895ec62c2c42e6cd075c2700843b89.csv") # For local use
